...
__attribute__((weak, alias("fail"))) void NMI_handler();
__attribute__((weak, alias("fail"))) void HardFault_handler();
__attribute__((weak, alias("fail"))) void MemManage_handler();
__attribute__((weak, alias("fail"))) void BusFault_handler();
__attribute__((weak, alias("fail"))) void UsageFault_handler();
__attribute__((weak, alias("fail"))) void SVC_handler();
__attribute__((weak, alias("fail"))) void DebugMon_handler();
__attribute__((weak, alias("fail"))) void PendSV_handler();
__attribute__((weak, alias("fail"))) void SysTick_handler();

__attribute__((weak, alias("fail"))) void DMA_channel_0_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_1_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_2_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_3_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_4_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_5_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_6_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_7_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_8_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_9_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_10_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_11_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_12_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_13_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_14_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_channel_15_complete_handler();
__attribute__((weak, alias("fail"))) void DMA_error_handler();
__attribute__((weak, alias("fail"))) void FPU_error_handler();
__attribute__((weak, alias("fail"))) void Flash_command_complete_handler();
__attribute__((weak, alias("fail"))) void Flash_read_collision_handler();
__attribute__((weak, alias("fail"))) void Low_voltage_detect_handler();
__attribute__((weak, alias("fail"))) void Low_leakage_wakeup_handler();
__attribute__((weak, alias("fail"))) void Watchdog_handler();
__attribute__((weak, alias("fail"))) void Random_number_generator_handler();
__attribute__((weak, alias("fail"))) void SPI0_handler();
__attribute__((weak, alias("fail"))) void SPI1_handler();
__attribute__((weak, alias("fail"))) void I2S0_transmit_handler();
__attribute__((weak, alias("fail"))) void I2S0_receive_handler();
__attribute__((weak, alias("fail"))) void LPUART0_status_and_error_handler();
__attribute__((weak, alias("fail"))) void UART0_status_handler();
__attribute__((weak, alias("fail"))) void UART0_error_handler();
__attribute__((weak, alias("fail"))) void UART1_status_handler();
__attribute__((weak, alias("fail"))) void UART1_error_handler();
__attribute__((weak, alias("fail"))) void UART2_status_handler();
__attribute__((weak, alias("fail"))) void UART2_error_handler();
__attribute__((weak, alias("fail"))) void ADC0_handler();
__attribute__((weak, alias("fail"))) void CMP0_handler();
__attribute__((weak, alias("fail"))) void CMP1_handler();
__attribute__((weak, alias("fail"))) void FTM0_handler();
__attribute__((weak, alias("fail"))) void FTM1_handler();
__attribute__((weak, alias("fail"))) void FTM2_handler();
__attribute__((weak, alias("fail"))) void Real_time_clock_alarm_handler();
__attribute__((weak, alias("fail"))) void Real_time_clock_seconds_handler();
__attribute__((weak, alias("fail"))) void Programmable_interrupt_timer_channel_0_handler();
__attribute__((weak, alias("fail"))) void Programmable_interrupt_timer_channel_1_handler();
__attribute__((weak, alias("fail"))) void Programmable_interrupt_timer_channel_2_handler();
__attribute__((weak, alias("fail"))) void Programmable_interrupt_timer_channel_3_handler();
__attribute__((weak, alias("fail"))) void Programmable_delay_block_handler();
__attribute__((weak, alias("fail"))) void USB_OTG_handler();
__attribute__((weak, alias("fail"))) void DAC0_handler();
__attribute__((weak, alias("fail"))) void Master_clock_generation_handler();
__attribute__((weak, alias("fail"))) void Low_power_timer_handler();
__attribute__((weak, alias("fail"))) void Pin_detect_port_A_handler();
__attribute__((weak, alias("fail"))) void Pin_detect_port_B_handler();
__attribute__((weak, alias("fail"))) void Pin_detect_port_C_handler();
__attribute__((weak, alias("fail"))) void Pin_detect_port_D_handler();
__attribute__((weak, alias("fail"))) void Pin_detect_port_E_handler();
__attribute__((weak, alias("fail"))) void Software_interrupt_handler();
__attribute__((weak, alias("fail"))) void FTM3_handler();
__attribute__((weak, alias("fail"))) void DAC1_handler();
__attribute__((weak, alias("fail"))) void ADC1_handler();
